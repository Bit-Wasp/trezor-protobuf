...
/**
 * Protobuf message : BitWasp.TrezorProto.NEMGetAddress
 */
class NEMGetAddress extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \BitWasp\TrezorProto\NEMGetAddress) {
