...
/**
 * Protobuf message : BitWasp.TrezorProto.SetU2FCounter
 */
class SetU2FCounter extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \BitWasp\TrezorProto\SetU2FCounter) {
