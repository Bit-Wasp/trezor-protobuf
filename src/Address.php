...
/**
 * Protobuf message : BitWasp.TrezorProto.Address
 */
class Address extends \Protobuf\AbstractMessage
{
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->address === null) {
            throw new \UnexpectedValueException('Field "\\BitWasp\\TrezorProto\\Address#address" (tag 1) is required but has no value.');
        }
    ...
    {
        if ( ! $message instanceof \BitWasp\TrezorProto\Address) {
