...
/**
 * Protobuf message : BitWasp.TrezorProto.NEMDecryptedMessage
 */
class NEMDecryptedMessage extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \BitWasp\TrezorProto\NEMDecryptedMessage) {
