...
/**
 * Protobuf message : BitWasp.TrezorProto.Ping
 */
class Ping extends \Protobuf\AbstractMessage
{
    ...
    /**
     * button_protection optional bool = 2
     *
     * @var bool
     */
    protected $button_protection = null;
    ...
    /**
     * Check if 'button_protection' has a value
     *
     * @return bool
     */
    public function hasButtonProtection()
    {
        return $this->button_protection !== null;
    }

    /**
     * Get 'button_protection' value
     *
     * @return bool
     */
    public function getButtonProtection()
    {
        return $this->button_protection;
    }

    /**
     * Set 'button_protection' value
     *
     * @param bool $value
     */
    public function setButtonProtection($value = null)
    {
        $this->button_protection = $value;
    }
    ...
    public static function fromArray(array $values)
    {
        ...
        $values  = array_merge([
            'message' => null,
            'button_protection' => null,
            'pin_protection' => null,
            'passphrase_protection' => null
        ], $values);

        $message->setMessage($values['message']);
        $message->setButtonProtection($values['button_protection']);
    ...
    public function writeTo(\Protobuf\WriteContext $context)
    {
        ...
        if ($this->button_protection !== null) {
            $writer->writeVarint($stream, 16);
            $writer->writeBool($stream, $this->button_protection);
        }
    ...
    public function readFrom(\Protobuf\ReadContext $context)
    {
        ...
        while ($limit === null || $stream->tell() < $limit) {
            ...
            if ($tag === 2) {
                ...
                $this->button_protection = $reader->readBool($stream);
    ...
    {
        if ( ! $message instanceof \BitWasp\TrezorProto\Ping) {
            throw new \InvalidArgumentException(sprintf('Argument 1 passed to %s must be a %s, %s given', __METHOD__, __CLASS__, get_class($message)));
        }

        $this->message = ($message->message !== null) ? $message->message : $this->message;
        $this->button_protection = ($message->button_protection !== null) ? $message->button_protection : $this->button_protection;
