...
/**
 * Protobuf message : BitWasp.TrezorProto.EthereumMessageSignature
 */
class EthereumMessageSignature extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \BitWasp\TrezorProto\EthereumMessageSignature) {
