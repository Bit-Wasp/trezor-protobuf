...
/**
 * Protobuf message : BitWasp.TrezorProto.FirmwareErase
 */
class FirmwareErase extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \BitWasp\TrezorProto\FirmwareErase) {
