...
/**
 * Protobuf message : BitWasp.TrezorProto.FirmwareRequest
 */
class FirmwareRequest extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \BitWasp\TrezorProto\FirmwareRequest) {
