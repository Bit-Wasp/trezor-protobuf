...
/**
 * Protobuf message : BitWasp.TrezorProto.NEMSignedTx
 */
class NEMSignedTx extends \Protobuf\AbstractMessage
{
    ...
    {
        if ( ! $message instanceof \BitWasp\TrezorProto\NEMSignedTx) {
